...
import { Car, Eye, EyeOff, Mail, Lock, ArrowRight, Leaf, AlertCircle } from "lucide-react";
      ...
      >
        ...
        <div className="glass-dark rounded-3xl p-8 border border-white/10 shadow-xl">
          ...
          <div className="grid grid-cols-2 gap-3">
            {/* Auth0 Login trigger */}
            <a href="http://localhost:5000/login" className="flex items-center justify-center gap-2 py-3 rounded-xl bg-white/5 border border-white/10 text-sm text-primary-foreground/70 hover:bg-white/10 transition-all">
            ...
            <button className="flex items-center justify-center gap-2 py-3 rounded-xl bg-white/5 border border-white/10 text-sm text-primary-foreground/70 hover:bg-white/10 transition-all">
